...
var Game = {  // a modified version of the game loop from my previous boulderdash game - see https://jakesgordon.com/writing/javascript-boulderdash/#gameloop 
  ...
  playMusic: function() {
    ...
    // Load media only after a user gesture. This avoids blocked autoplay and
    // aborted speculative media requests in Chromium.
    var started = false;
    var startMusic = function() {
      if (started) return;
      started = true;
      music.src = music.getAttribute('data-src');
