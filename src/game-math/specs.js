...
export const SPECS = [
  ...
  {
    id: 'wild-west-gold',
    tuning: { premiumTaper: 0.07, tierScale: { high: 1.2, mid: 1.05 }, wildScale: 1.4, freeSpinMultiplier: 3 },
    title: 'Wild West Gold',
    volatility: 'high',
    paylines: 20,
    targetRtp: 0.962,
    scatterAward: 'standard',
    wildPlacement: 'reelsTwoThreeFour',
    feature: 'stickyMultiplierWild',
    theme: {
      backgroundHue: HUES.crimson,
      backgroundLightness: 0.07,
      accentHue: HUES.gold,
    ...
    symbols: [
      sym('sheriff', 'premium', "Sheriff's Star", 'sigil', { rays: 6, inner: 0.35 }, HUES.gold),
      sym('cactus', 'premium', 'Iron Cactus', 'flora', { lobes: 4, thorns: true }, HUES.emerald),
      sym('whiskey', 'high', 'Whiskey Bottle', 'vessel', { neck: 0.38, belly: 0.65 }, HUES.amber),
      sym('horseshoe', 'high', 'Gold Horseshoe', 'instrument', { arms: 3, hub: 0.15 }, HUES.slate),
      sym('dynamite', 'mid', 'Dynamite Stick', 'vessel', { neck: 0.1, belly: 0.9 }, HUES.crimson),
      sym('tumbleweed', 'mid', 'Tumbleweed', 'flora', { lobes: 7 }, HUES.sand),
      ...ranks('rank', { sides: 5 }, [HUES.crimson, HUES.amber, HUES.gold, HUES.sand]),
    ],
    wild: sym('wild', 'premium', 'Wild West Wild', 'sigil', { rays: 8, inner: 0.28 }, HUES.gold),
    scatter: sym('scatter', 'mid', 'Wanted Poster', 'tome', { emblem: 5 }, HUES.sand),
  },

  // ─────────────────────────────────────────────────────────
  {
    id: 'super-line-fruit-bomb',
    tuning: { premiumTaper: 0.04, tierScale: { mid: 1.15, low: 1.0 }, wildScale: 1.25, scatterScale: 1.0 },
    ...
    scatterAward: 'standard',
    wildPlacement: 'middleThree',
    feature: 'bombWildConversion',
    theme: {
      backgroundHue: HUES.crimson,
      backgroundLightness: 0.075,
      accentHue: HUES.lime,
      secondaryHue: HUES.rose,
      metal: 'silver',
    },
    symbols: [
      sym('bomb', 'premium', 'Super Bomb', 'vessel', { neck: 0.15, belly: 0.85 }, HUES.slate),
      sym('seven', 'premium', 'Lucky Seven', 'sigil', { rays: 0, inner: 0 }, HUES.gold),
      sym('bar', 'high', 'BAR Symbol', 'coin', { emblem: 3 }, HUES.lime),
      sym('melon', 'high', 'Watermelon Slice', 'flora', { lobes: 6, seeds: true }, HUES.rose),
      sym('lemon', 'mid', 'Lemon', 'flora', { lobes: 5, pointy: true }, HUES.lime),
      sym('plum', 'mid', 'Plum', 'flora', { lobes: 4, round: true }, HUES.violet),
      ...ranks('rank', { sides: 4 }, [HUES.crimson, HUES.rose, HUES.lime, HUES.gold]),
    ],
    wild: sym('wild', 'premium', 'Bomb Wild', 'vessel', { neck: 0.12, belly: 0.88 }, HUES.crimson),
    scatter: sym('scatter', 'mid', 'Bonus Bell', 'vessel', { neck: 0.45, belly: 0.75 }, HUES.gold),
  },

  // ─────────────────────────────────────────────────────────
  {
    id: 'lucky-streak',
    tuning: { premiumTaper: 0.06, tierScale: { premium: 1.0, high: 1.1 }, wildScale: 1.15, freeSpinMultiplier: 2.5 },
    title: 'Lucky Streak',
    volatility: 'high',
    paylines: 15,
    targetRtp: 0.96,
    ...
    symbols: [
      sym('clover', 'premium', 'Four-Leaf Clover', 'flora', { lobes: 4, glow: true }, HUES.emerald),
      sym('horseshoe', 'premium', 'Lucky Horseshoe', 'instrument', { arms: 3, hub: 0.18 }, HUES.gold),
      sym('coin-stack', 'high', 'Coin Stack', 'coin', { emblem: 5, stack: true }, HUES.amber),
      sym('ring', 'high', 'Gold Ring', 'gem', { sides: 6, squash: 0.85 }, HUES.gold),
      sym('card-ace', 'mid', 'Ace of Clubs', 'sigil', { rays: 0, inner: 0 }, HUES.emerald),
      sym('dice-six', 'mid', 'Dice Six', 'gem', { sides: 6, squash: 0.95 }, HUES.cyan),
      ...ranks('rank', { sides: 7 }, [HUES.emerald, HUES.lime, HUES.cyan, HUES.gold]),
    ],
    wild: sym('wild', 'premium', 'Streak Wild', 'sigil', { rays: 10, inner: 0.25 }, HUES.lime),
    scatter: sym('scatter', 'mid', 'Lucky Star', 'sigil', { rays: 8, inner: 0.4 }, HUES.gold),
  },
  // ─────────────────────────────────────────────────────────
  {
    id: 'diamond-rush',
