...
a(' */')
a('')
a('test.describe(' + chr(39) + 'Instant Games API' + chr(39) + ', () => {')
...
with open(r'f:/Kaziksites/test/playwright/tests/api.instant.spec.js', 'w', encoding='utf-8') as f:
    f.write('\n'.join(lines))

print(f"Written {len(lines)} lines to test file")
